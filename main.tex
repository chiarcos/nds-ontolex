...
\begin{table}
    \centering
    \includegraphics[width=0.8\linewidth]{img/dialects-and-iso632-codes.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{img/tsv-linked.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{img/links-vis.png}
