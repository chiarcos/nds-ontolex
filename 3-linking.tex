...
\item[WWB] Westfälisches Wörterbuch from Wörterbuchnetz (for German dialects of Westphalian, \code{wep}).
...
We produce linking files in two different flavours. The condensed format only conveys a \onto{lexinfo:geographicalVariant} link between two lexical entries.\ign{
\footnote{
